...
const Test = () => {
    ...
    const onFormSubmit = (event) => {
        ...
        console.log(firstName + ' ' + lastName + ' ' + email + ' ' + password + ' ' + address + ' ' + city + ' ' + type + ' ' + zip);
    }
    const navigate = useNavigate();
    return (
        <div className='row'>
            <div className='col-4' style={{ backgroundColor: "red", height: "100px" }}>
                Signup</div>
            
                <div className="bg-white p-4 rounded w-50 col-8">
